...
declare -a PretrainedModelUrls=(
    ...
    "http://storage.googleapis.com/deep_fashion_multimodal/pre_trained_models/e4e_deep_fashion.pt"
    "http://storage.googleapis.com/deep_fashion_multimodal/pre_trained_models/stylegan-deepfashion256x256_2.pt"
